...
class AverageOfSeveralIdenticalRun:
    ...
    def append(self, new_descent: AGradientDescent):
        ...
        self.avg_h_i_to_optimal_grad.append(new_descent.avg_h_i_to_optimal_grad)
        self.tail_avg_h_i_to_optimal_grad.append(new_descent.tail_avg_h_i_to_optimal_grad)
